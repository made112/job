                                ...
                                <div id="company">
                                    @foreach($company as $item)
                                        <div class="model-box">
                                            <div class="detail">
                                                <div class="image">
                                                    <img width="280px" height="250px" src="{{asset('images/front_images/job/1.png')}}">
                                                </div>
                                                <div class="desc-job">
                                ...
                                <div id="candidate">
                                    @foreach($user as $item)
                                        <div class="model-box">
                                            <div class="detail">
                                                <div class="image">
                                                    <img title="personal image" alt="personal image" width="280px" height="250px" src="{{$item->picture}}">
                                                </div>
                                                <div class="desc-job">
                                                    <p class="title-type"><span class="sub-title">{{$item->std_name}}</span></p>
                                                    <p class="title-type"><span class="sub-title">{{$item->country}}</span></p>
...
<div id="sidebar">
    <form method="get" action="{{route('browse.filter')}}">
        @csrf
            ...
            <article class="filter-group">
                ...
                <article class="filter-group">
                    ...
                    <div class="filter-content collapse show" id="collapse_5">
                        <div class="card-body">
                            {{--                            <input  type="range" class="custom-range" min="0" max="5000" name="salary">--}}
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Min</label>
                                    <input name="salary_min" class="form-control" placeholder="$0" type="number">
                                </div>
                                <div class="form-group text-right col-md-6">
                                    <label>Max</label>
                                    <input name="salary_max" class="form-control" placeholder="$1,0000" type="number">
                                </div>
                            </div>
                            <!-- form-row.// -->
                        ...
                        <div class="card-body">
                            @foreach($skills as $item)
                                <label class="checkbox-btn">
                                    <input name="skill_id" value="{{$item->id}}" type="checkbox">
                                    <span class="btn btn-light"> {{$item->name}} </span>
                                </label>

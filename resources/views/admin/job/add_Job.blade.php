                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="job_title" type="text" class="form-control" id="name" placeholder="Enter Job">
                                        @error("job_title")
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="description" type="text" class="form-control" id="description" placeholder="Enter Job description">
                                        @error("description")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="video" type="file" class="form-control" id="description" placeholder="Enter Job description">
                                        @error("video")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
